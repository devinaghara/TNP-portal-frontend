...
const FacultySignUpPage = () => {
    ...
    const [formData, setFormData] = useState({
        name: state?.name || "",
        facultyId: "",
        collageName: "", // Changed from collegeName to match backend
        departmentName: "",
        mobileNumber: "",
        linkedinProfile: "",
    });
    ...
    useEffect(() => {
        ...
        if (!state?.email || !role || role !== "Faculty") {
            navigate("/signup");
        }
    ...
    const handleSubmit = async (event) => {
        ...
        const facultyData = {
            ...
            collageName: formData.collageName, // Matches backend field name
            departmentName: formData.departmentName,
            mobileNumber: formData.mobileNumber.replace(/\s/g, ''), // Remove any spaces
